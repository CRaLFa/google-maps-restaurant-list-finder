...
40 件中 38 件を取得し、トップリストと地元で人気は 168 エリア全部で揃った。

未取得は以下の 2 件。

- `代官山町: トレンド` — カルーセルにトップリストと地元で人気の 2 枚しかなく、**リストが存在しない**ことを確認済み (その後 Google 側に追加され、2026-09-13 に収録した)。
